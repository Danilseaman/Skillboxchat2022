...
json_db = open(db_file, "r", encoding="utf-8")  # Открываем файл
...
def save_messages():
    ...
    json_db = open(db_file, "w", encoding="utf-8")
    json.dump(data, json_db, ensure_ascii=False)  # Записываем данные в файл
